...
This README is the SDKWork module entrypoint for `sdkwork-terminal-pty-runtime`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.

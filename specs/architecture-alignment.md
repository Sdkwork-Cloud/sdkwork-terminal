...
**This repository**: `terminal-pc-commons` re-exports `isBlank` from `@sdkwork/utils/string` and centralizes `extractErrorMessage`; Rust crates `runtime-node`, `ai-cli-host`, and `resource-connectors` validate blank fields with `sdkwork_utils_rust::is_blank`.

**Posture**: integrated for TypeScript commons, release checksum tooling, and Rust runtime validation.
...
## Code,??, performance, security, testing
...
| EX-2026-PC-001..004 | PC app surface exceptions | [`apps/sdkwork-terminal-pc/specs/GOVERNANCE_EXCEPTIONS.md`](../apps/sdkwork-terminal-pc/specs/GOVERNANCE_EXCEPTIONS.md) (001/003 resolved pass 11; 004 narrowed) |

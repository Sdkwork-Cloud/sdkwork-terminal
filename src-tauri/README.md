...
This README is the SDKWork module entrypoint for `sdkwork-terminal-desktop-host`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-terminal/src-tauri/Cargo.toml`

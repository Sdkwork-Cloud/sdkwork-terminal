...
- `pnpm run test:runtime-event-name-contract`: run the configured test suite for this scope.
- `pnpm run verify:shell-package`: run repository verification or architecture checks.
- `pnpm run verify:terminal-runtime`: run repository verification or architecture checks.
- `pnpm run verify:typescript-probes`: run repository verification or architecture checks.
- `pnpm run verify:windows-release`: run repository verification or architecture checks.

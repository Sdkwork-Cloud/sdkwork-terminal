...
| Desktop Host + Local Session Daemon | `02` `10` `16` | `04` | `src/entries/desktop-main.tsx` `packages/sdkwork-terminal-pc-desktop/src-tauri/` `crates/sdkwork-terminal-session-runtime/` | daemon lifecycle 测试、desktop bridge 测试、cargo check | `Step 04 已达 L3` |
...
| Server Mode | `02` `10` `16` `17` | `10` | `src/entries/web-main.tsx` `src/surfaces/web-app.tsx` `crates/sdkwork-terminal-control-plane/` `crates/sdkwork-terminal-runtime-node/` | public/manage/internal/runtime-stream 验证、broker/node smoke | `未开始` |

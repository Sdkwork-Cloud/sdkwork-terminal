...
Platform IAM and business APIs are consumed through generated SDKs from sibling repositories (`sdkwork-appbase`, `sdkwork-api-gateway`). Do not add raw HTTP wrappers here for platform surfaces.

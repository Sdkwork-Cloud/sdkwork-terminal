...
Platform IAM and business APIs are consumed through generated SDKs using the declared `platform.api-gateway` surface URL. Do not add raw HTTP wrappers here for platform surfaces.

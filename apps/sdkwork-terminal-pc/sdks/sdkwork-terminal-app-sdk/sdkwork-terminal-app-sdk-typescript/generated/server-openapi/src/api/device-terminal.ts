...
export interface DeviceTerminalDeviceTerminalSessionsReplayListParams {
  cursor?: string;
  pageSize?: number;
}

export class DeviceTerminalDeviceTerminalSessionsReplayApi {
...
export class DeviceTerminalDeviceTerminalSessionsApi {
  private client: HttpClient;
  public readonly replay: DeviceTerminalDeviceTerminalSessionsReplayApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.replay = new DeviceTerminalDeviceTerminalSessionsReplayApi(client);
  }
...
export class DeviceTerminalDeviceTerminalApi {
  private client: HttpClient;
  public readonly sessions: DeviceTerminalDeviceTerminalSessionsApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.sessions = new DeviceTerminalDeviceTerminalSessionsApi(client);
  }

}

export class DeviceTerminalDeviceApi {
  private client: HttpClient;
  public readonly terminal: DeviceTerminalDeviceTerminalApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.terminal = new DeviceTerminalDeviceTerminalApi(client);
  }

}

export class DeviceTerminalApi {
  private client: HttpClient;
  public readonly device: DeviceTerminalDeviceApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.device = new DeviceTerminalDeviceApi(client);
  }

}

export function createDeviceTerminalApi(client: HttpClient): DeviceTerminalApi {
  return new DeviceTerminalApi(client);
}

import type { DesktopSessionAttachmentSnapshot } from "@sdkwork/terminal-pc-infrastructure";
import type { SessionCenterSession } from "@sdkwork/terminal-pc-sessions/model";

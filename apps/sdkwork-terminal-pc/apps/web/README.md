...
This README is the SDKWork module entrypoint for `sdkwork-terminal-web`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `pnpm --filter @sdkwork/terminal-web typecheck`

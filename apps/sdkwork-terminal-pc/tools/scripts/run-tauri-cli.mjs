...
const desktopDir = path.join(rootDir, "packages", "sdkwork-terminal-pc-desktop");
...
function resolveMergedTauriConfig(args, workspaceRoot) {
  const baseConfigPath = path.join(workspaceRoot, "packages", "sdkwork-terminal-pc-desktop", "src-tauri", "tauri.conf.json");

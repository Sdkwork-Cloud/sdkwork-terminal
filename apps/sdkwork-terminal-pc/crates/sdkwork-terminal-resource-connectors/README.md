...
This README is the SDKWork module entrypoint for `sdkwork-terminal-resource-connectors`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-terminal/crates/sdkwork-terminal-resource-connectors/Cargo.toml`

# SDKWork Terminal Protocol Component Specs

This directory is the local standards index for `sdkwork-terminal-protocol`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-terminal-protocol` |
| Type | `rust-crate` |
| Root | `apps/sdkwork-terminal-pc/crates/sdkwork-terminal-protocol` |
| Domain | `content` |
...
- `cargo test --manifest-path apps/sdkwork-terminal/crates/sdkwork-terminal-protocol/Cargo.toml`

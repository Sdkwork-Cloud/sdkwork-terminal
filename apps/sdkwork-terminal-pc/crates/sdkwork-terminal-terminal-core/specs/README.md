# SDKWork Terminal Terminal Core Component Specs

This directory is the local standards index for `sdkwork-terminal-terminal-core`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-terminal-terminal-core` |
| Type | `rust-crate` |
| Root | `apps/sdkwork-terminal-pc/crates/sdkwork-terminal-terminal-core` |
| Domain | `content` |
...
- `cargo test --manifest-path apps/sdkwork-terminal/crates/sdkwork-terminal-terminal-core/Cargo.toml`

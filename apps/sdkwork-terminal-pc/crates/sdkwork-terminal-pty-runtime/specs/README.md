# SDKWork Terminal Pty Runtime Component Specs

This directory is the local standards index for `sdkwork-terminal-pty-runtime`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-terminal-pty-runtime` |
| Type | `rust-crate` |
| Root | `apps/sdkwork-terminal-pc/crates/sdkwork-terminal-pty-runtime` |
...
- `cargo test --manifest-path apps/sdkwork-terminal/crates/sdkwork-terminal-pty-runtime/Cargo.toml`

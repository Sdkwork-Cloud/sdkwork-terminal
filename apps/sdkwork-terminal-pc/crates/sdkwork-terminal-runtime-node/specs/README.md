# SDKWork Terminal Runtime Node Component Specs

This directory is the local standards index for `sdkwork-terminal-runtime-node`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-terminal-runtime-node` |
| Type | `rust-crate` |
| Root | `apps/sdkwork-terminal-pc/crates/sdkwork-terminal-runtime-node` |
...
- `cargo test --manifest-path apps/sdkwork-terminal/crates/sdkwork-terminal-runtime-node/Cargo.toml`

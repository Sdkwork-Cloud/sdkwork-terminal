# SDKWork Terminal Config Component Specs

This directory is the local standards index for `sdkwork-terminal-config`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-terminal-config` |
| Type | `rust-crate` |
| Root | `apps/sdkwork-terminal-pc/crates/sdkwork-terminal-config` |
| Domain | `content` |

...
This README is the SDKWork module entrypoint for `sdkwork-terminal-observability`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-terminal/crates/sdkwork-terminal-observability/Cargo.toml`

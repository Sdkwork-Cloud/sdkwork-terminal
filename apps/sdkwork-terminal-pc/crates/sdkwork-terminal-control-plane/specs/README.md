# SDKWork Terminal Control Plane Component Specs

This directory is the local standards index for `sdkwork-terminal-control-plane`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-terminal-control-plane` |
| Type | `rust-crate` |
| Root | `apps/sdkwork-terminal-pc/crates/sdkwork-terminal-control-plane` |
| Domain | `content` |
...
- `cargo test --manifest-path apps/sdkwork-terminal/crates/sdkwork-terminal-control-plane/Cargo.toml`

# SDKWork Terminal Ai Cli Host Component Specs

This directory is the local standards index for `sdkwork-terminal-ai-cli-host`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-terminal-ai-cli-host` |
| Type | `rust-crate` |
| Root | `apps/sdkwork-terminal-pc/crates/sdkwork-terminal-ai-cli-host` |
| Domain | `content` |
...
- `cargo test --manifest-path apps/sdkwork-terminal/crates/sdkwork-terminal-ai-cli-host/Cargo.toml`

# SDKWork Terminal Session Runtime Component Specs

This directory is the local standards index for `sdkwork-terminal-session-runtime`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-terminal-session-runtime` |
| Type | `rust-crate` |
| Root | `apps/sdkwork-terminal-pc/crates/sdkwork-terminal-session-runtime` |
...
- `cargo test --manifest-path apps/sdkwork-terminal/crates/sdkwork-terminal-session-runtime/Cargo.toml`

...
pub struct DesktopAiCliLaunchRequest {
    pub cli_kind: sdkwork_terminal_ai_cli_host::AiCliKind,
    pub working_directory: Option<String>,
...
mod commands {
    ...
    use super::{
        ...
        run_local_shell_exec, DesktopAiCliLaunchRequest, DesktopAiCliLaunchSnapshot,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::desktop_ai_cli_discovery,
            commands::desktop_ai_cli_launch
        ])

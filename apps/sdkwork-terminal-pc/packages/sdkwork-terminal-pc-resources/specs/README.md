...
This directory is the local standards index for `@sdkwork/terminal-resources`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/terminal-resources` |
| Type | `react-package` |
| Root | `sdkwork-terminal/packages/sdkwork-terminal-resources` |
| Domain | `content` |

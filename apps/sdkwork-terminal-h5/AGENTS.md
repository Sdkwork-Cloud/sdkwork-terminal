...
- Local directories to inspect first when relevant: `src/`, `packages/`, `config/`, `tests/`, `scripts/`, `docs/`.
...
- H5 application: `../../../sdkwork-specs/APP_H5_ARCHITECTURE_SPEC.md` and `../../../sdkwork-specs/APP_MOBILE_REACT_UI_SPEC.md`.
...
Load language specs only when touched: TypeScript uses `TYPESCRIPT_CODE_SPEC.md`, frontend uses `FRONTEND_CODE_SPEC.md`.

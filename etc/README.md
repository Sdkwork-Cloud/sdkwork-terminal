# sdkwork-terminal Source Configuration
...
| `runtimeCode` | `terminal` |
| Config root | `/etc/sdkwork/terminal/` |
| Runtime TOML | `/etc/sdkwork/terminal/config.toml` |
| Secrets | `/etc/sdkwork/terminal/secrets/` |
| Override | `SDKWORK_TERMINAL_CONFIG_FILE` |

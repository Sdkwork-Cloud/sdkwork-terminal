...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `terminal-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `terminal-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `terminal-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `terminal-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `terminal.sdkwork.com` | 443 ssl + 80 |

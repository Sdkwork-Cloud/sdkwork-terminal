...
Module `sdkwork-terminal` · runtime code `terminal` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `terminal-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `terminal-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `terminal-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `terminal-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `terminal.sdkwork.com` | 443 ssl + 80 |

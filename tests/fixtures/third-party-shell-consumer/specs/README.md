...
This directory is the local SDKWork component contract for `third-party-shell-consumer-fixture`.

- Component root: `sdkwork-terminal/tests/fixtures/third-party-shell-consumer`

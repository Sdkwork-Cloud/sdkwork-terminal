# third-party-shell-consumer-fixture

Domain: device
Capability: third-party-shell-consumer-fixture
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `third-party-shell-consumer-fixture`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../sdkwork-specs/`.
